  ...
  return fetch("https://ezanvakti.herokuapp.com/ulkeler")
    ...
    .then((data) => {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if(data[i].UlkeAdi == "TÜRKİYE"){
                indexTurkiye=i;
            }
        }

        document.getElementById('countries').innerHTML=html;
        document.getElementById('countries').selectedIndex = indexTurkiye;
...
function GetPrayerTimes(countyId){
    ...
    .then(data => {
        ...
        document.getElementById('imsak').innerText="İMSAK "+selectedData.Imsak;
        document.getElementById('gunes').innerText="GÜNEŞ "+selectedData.Gunes;
        document.getElementById('ogle').innerText="ÖĞLE "+selectedData.Ogle;
        document.getElementById('ikindi').innerText="İKİNDİ "+selectedData.Ikindi;
        document.getElementById('aksam').innerText="AKŞAM "+selectedData.Aksam;
        document.getElementById('yatsi').innerText="YATSI "+selectedData.Yatsi;

        clearInterval(counter);
        counter = setInterval(function(){
            IftaraKalanSure(selectedData.Aksam);
        },1000);
