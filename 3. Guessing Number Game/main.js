...
function ShowButton(buttonId){
    document.getElementById(buttonId).classList.add('btn-show');
    document.getElementById(buttonId).classList.remove('btn-hide');

}

function HideButton(buttonId){
    document.getElementById(buttonId).classList.add('btn-hide');
    document.getElementById(buttonId).classList.remove('btn-show');
}